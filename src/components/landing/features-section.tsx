        ...
        <div className="py-24 bg-white dark:bg-gray-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Feature 1 */}
                    <div className="group p-8 rounded-2xl bg-gray-50 dark:bg-gray-800 hover:bg-white dark:hover:bg-gray-700 hover:shadow-xl transition-all duration-300">
                        ...
                        <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Smart Booking</h3>
                    ...
                    <div className="group p-8 rounded-2xl bg-gray-50 dark:bg-gray-800 hover:bg-white dark:hover:bg-gray-700 hover:shadow-xl transition-all duration-300">
                        ...
                        <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Secure & Flexible</h3>
                        <p className="text-black dark:text-gray-300 leading-relaxed">
