        ...
        <div className="relative py-32 overflow-hidden bg-gradient-to-b from-white via-gray-50 to-gray-100">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-3xl mx-auto">
                    <span className="inline-block px-4 py-2 text-blue-600 text-sm font-medium mb-6">
                        ✨ Join Our Community
                    </span>
                    ...
                    <div className="flex flex-row gap-6 justify-center items-center w-full mt-6">
                        <button className="group flex items-center gap-3 px-6 py-3 bg-blue-600 text-white rounded-full font-bold text-base shadow-md hover:bg-blue-700 focus:bg-blue-800 focus:outline-none transition-all duration-200">
                        ...
                        <Link
                            href="/signin"
                            className="group flex items-center gap-3 px-6 py-3 bg-white text-blue-600 border-2 border-blue-600 rounded-full font-bold text-base shadow-md hover:bg-blue-50 hover:text-blue-700 focus:bg-blue-100 focus:outline-none transition-all duration-200"
                        >
                            <span>Sign In</span>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
